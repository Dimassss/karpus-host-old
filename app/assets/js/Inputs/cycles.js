...
class CyclesInput extends Input{
  constructor(){
    ...
    const inputs = [
                    ...
                    ["pr_Unt", ".cycles-container .w-products select#js-product-unit", "v", "t1"],
                    ...
                    ["AW_Adr", ".alert-window input#js-addresses", "v", "t9"],
    ...
    const takes = {
                    "t1": (s, v, r) => {
                      ...
                      */
                      const a = r(q(s).value);
                      if(v(a)) return a;
                      else console.assert(false, {field: s ,class: "Cycles", src: "js/HTML_Input/customerProfile.js", errorMsg: "Invalid input", data: a});
                    },
                    "t2": (s, v, r) => {
                      /**
                    ...
                    "t13": (s, v, r) => {
                      return parseInt(r(q(s).getAttribute("data-customer-id")));
                    }
                  };
    const validators = {
                        "v": () => true,
